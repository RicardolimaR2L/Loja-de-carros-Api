export const MiddlewareMessagesHelper = {
    DB_CONNECTION_STRING_NOT_PROVIDED: 'Env de configuração do banco não informada.',
    CORS_POLICY_ERROR: 'Ocorreu erro ao tratar a política de CORS.',
